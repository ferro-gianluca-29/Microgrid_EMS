...
input_features, _ = create_windows(price.values[:2000], lookback, forecast_horizon)

# Usiamo solo i dati di prezzo per i target
_, target_price = create_windows(price.values[:2000], lookback, forecast_horizon)
...
_, P_r_windows = create_windows(P_r.values[:2000], lookback, forecast_horizon)
_, P_l_windows = create_windows(P_l.values[:2000], lookback, forecast_horizon)
